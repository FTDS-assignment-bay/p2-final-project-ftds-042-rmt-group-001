...
with DAG('final_project_group01_rmt042',
         description='final_projek_ftds_rmt042_group01',
         default_args=default_args,
         schedule_interval='0 0 * * *', # menjadwalkan DAG agar berjalan setiap hari pada pukul 00:00 UTC (07:00 WIB)
         start_date=dt.datetime(2025, 6, 14) + timedelta(hours=7), # (UTC -7) karena saya berada di zona pdt
